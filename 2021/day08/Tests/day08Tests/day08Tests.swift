...
final class day08Tests: XCTestCase {
    func testPart1Sample() throws {
        let actual = day08.solve(sampleInput, countingNumbersIn: [1, 4, 7, 8])
        XCTAssertEqual(actual, 26)
    }

    func testPart1Real() throws {
        let actual = day08.solve(realInput, countingNumbersIn: [1, 4, 7, 8])
        XCTAssertEqual(actual, 301)
    }

    func testPart2Sample() throws {
        let actual = day08.solvePart2(sampleInput)
        XCTAssertEqual(actual, 61229)
    }

    func testPart2Real() throws {
        let actual = day08.solvePart2(realInput)
        XCTAssertEqual(actual, 908_067)
    }
}
