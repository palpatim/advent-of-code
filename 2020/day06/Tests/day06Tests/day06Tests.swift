...
final class day06Tests: XCTestCase {
    func testPart1Sample() {
        let actual = day06.solvePart1(sampleInput)
        XCTAssertEqual(11, actual)
    }

    func testPart1Real() {
        let actual = day06.solvePart1(realInput)
        XCTAssertEqual(6903, actual)
    }

    func testPart2Sample() {
        let actual = day06.solvePart2(sampleInput)
        XCTAssertEqual(6, actual)
    }

    func testPart2Real() {
        let actual = day06.solvePart2(realInput)
        XCTAssertEqual(3493, actual)
    }
